...
from src.actions.actions import setBuildingAdjacency, toggleAutoRepair, allowAllBases, allowAllBasesForCountry
from src.actions.readers import getAllCountries
...
class BuildingsTab(Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.set_building_adjacency_frame = LabelFrame(self, text="Building Adjacency")
        ...
        self.allow_auto_repair_frame = LabelFrame(self, text="Auto Repair")
        ...
        self.allow_all_bases_for_all_frame = LabelFrame(self, text="All Bases For All Countries")
        ...
        self.allow_all_bases_for_country_frame = LabelFrame(self, text="All Bases For Country")
